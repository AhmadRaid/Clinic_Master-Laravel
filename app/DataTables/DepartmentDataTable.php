...
class DepartmentDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('checkbox', 'Departments.btn.checkbox')
        ->addColumn('options', 'Departments.btn.options')
        ->rawColumns([
                'options',
                'checkbox',
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons'=>[
                            ['text'=>'<i class="fa fa-plus">انشاء قسم جديد</i>', 'className'=>'btn btn-primary btn-rounded',
                            "action"=>"function(){
