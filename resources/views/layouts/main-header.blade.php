					...
					<div class="main-header-right">
							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Flag_of_Egypt.svg/250px-Flag_of_Egypt.png" alt="img"></span>
										<div class="my-auto">
											<strong class="mr-2 ml-2 my-auto">عربي</strong>
										</div>
									</a>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="https://ladiescarservices.com/wp-content/uploads/2020/07/Client-Ladies-car-services.jpg"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="https://ladiescarservices.com/wp-content/uploads/2020/07/Client-Ladies-car-services.jpg" class=""></div>
											<div class="mr-3 my-auto">
												<h6>{{ Auth::user()->name }}</h6><span>{{trans('admin.'.Auth::user()->roles_name)}}</span>
											</div>
										</div>
									</div>
