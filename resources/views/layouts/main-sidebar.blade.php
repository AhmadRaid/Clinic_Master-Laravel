<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				...
				<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}"><img src="https://www.itcodedev.com/storage/settings/667ESXBADR6BcNFuxr3smX6PZuYh0AYQF7N9PMJg.png" class="main-logo dark-theme" alt="logo"></a>
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="https://ladiescarservices.com/wp-content/uploads/2020/07/Client-Ladies-car-services.jpg"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
							<h4 class="font-weight-semibold mt-3 mb-0">{{ Auth::user()->name }}</h4>
							<span class="mb-0 text-muted">{{trans('admin.'.Auth::user()->roles_name)}}</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<i class="mdi mdi-account "></i>  <span class="side-menu__label pr-2">الاعضاء   </span>  <i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">الاعضاء</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='users?level=Admim') }}">الادارة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='users?level=Supervisor') }}">الاستقبال</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='users/create') }}">انشاء عضو جديد</a></li>
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<i class="mdi mdi-account "></i>  <span class="side-menu__label pr-2">المرضي   </span>  <i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='user/patient') }}">المرضي</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='patient/add') }}">انشاء مريض جديد</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='body/add') }}">اضافة بيانات الجسم للمريض</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='physical/add') }}">اضافاة بيانات القياسات للمريض</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='heightweight/add') }}">اضافة بيانات الطول والوزن للمريض</a></li>
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<i class="si si-list"></i>  <span class="side-menu__label pr-2">   الاقسام</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='department') }}">الاقسام</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='department/create') }}">انشاء قسم جديد</a></li>
						</ul>
					</li>
					
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<i class="si si-layers"></i><span class="side-menu__label pr-2">الخدمات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='service') }}">الخدمات</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='service/create') }}">انشاء خدمة جديد</a></li>
						</ul>
					</li>
					
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<i class="mdi mdi-account-circle"></i><span class="side-menu__label pr-2">الاطباء</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='doctor') }}">الاطباء</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='doctor/create') }}">انشاء طبيب جديد</a></li>
						</ul>
					</li>
			
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<i class="fe fe-clipboard"></i><span class="side-menu__label pr-2">الحجوزات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='booking') }}">الحجوزات</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='booking/create') }}">انشاء حجز جديد</a></li>
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<i class="fe fe-clipboard"></i><span class="side-menu__label pr-2">روشتة </span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='patient') }}">الروشتة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='patient/create') }}">انشاء روشتة  جديد</a></li>
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							<i class="fe fe-clipboard"></i><span class="side-menu__label pr-2">تقارير مالية </span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='FinancialDaily') }}">تقرير يومى</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='FinancialMonthly') }}">تقرير شهري</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='FinancialYearly') }}">تقرير سنوى</a></li>
						</ul>
					</li>
