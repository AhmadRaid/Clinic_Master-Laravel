        ...
        <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">حجز جديد</h4>
                    {{--<p class="mb-2">It is Very Easy to Customize and it uses in your website apllication.</p>--}}
                </div>
                <div class="card-body pt-0">
                    {!! Form::open(['url'=>url('booking')])!!}
                    <div class="row">

                    <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                {!! Form::label('patient_id', 'اسم المريض',['class'=>'form-control-label col-sm-2'])!!}
                                {!! Form::select('patient_id', App\Models\User::where('roles_name','User')->pluck('name', 'id'), old('patient_id'),['class'=>'form-control select2', 'placeholder' => '..............'])!!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                {!! Form::label('service_id', 'اسم الخدمة',['class'=>'form-control-label col-sm-2'])!!}
                                {!! Form::select('service_id', App\Models\Service::pluck('name', 'id'), old('service_id'),['class'=>'form-control select2 id', 'placeholder' => '..............'])!!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                {!! Form::label('date','موعد الحجز',['class'=>'form-control-label col-sm-2'])!!}
                                {!! Form::date('date',new \Carbon\Carbon(),['class'=>'form-control', 'placeholder' => 'موعد الحجز'])!!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                {!! Form::label('time','وقت الحجز',['class'=>'form-control-label col-sm-2'])!!}
                                {!! Form::time('time', new \Carbon\Carbon(),['class'=>'form-control', 'placeholder' => 'موعد الحجز'])!!}
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                   ...
                   <div class="hidden"></div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label class="label" for="">السعر :ج</label>
                            </div>
                        </div>
