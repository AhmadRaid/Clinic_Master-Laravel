        ...
        <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
            <div class="card  box-shadow-0">
                ...
                <div class="card-body pt-0">
                    {!! Form::open(['url'=>route('patientreports.update', $report->id), 'method' => 'put'])!!}
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 booking_id" style="display: {{ $report->appointment == null ? 'none' : 'block' }}">
                            <div class="form-group">
                                <label for="appointment" class="col-form-label">موعد حجز المريض</label>
                                <input type="text" class="form-control booking" value="{{ $report->appointment }}" name="appointment">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="note" value="{{ $report->note }}"
                                       autocomplete="off">
                            </div>
                        </div>
